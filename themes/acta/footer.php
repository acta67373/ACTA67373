	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="container">
			<div class="site-info col-3-md">
				...
				<?php 
				if (!is_page( array('rider-feedback', 'Free Ride', 'Giveaways', 'Survey', 'Validation') )) {
						echo "<div class='contact-info'>";
						echo "<div class='phone'><a href='tel:+1<?php the_field('phone', 'option'); ?>'>";
						the_field('phone', 'option');
						echo "</a> Phone</div>";
						echo "<div class='fax'>";
						the_field('fax', 'option');
						echo "Fax</div>";
						echo "</div>";
					}
				?>
			...
			<div class="footer-nav col-9-md">
				<?php 
				if (!is_page( array('rider-feedback', 'Free Ride', 'Giveaways', 'Survey', 'Validation') )) {
						wp_nav_menu( array( 'theme_location' => 'primary', 'menu_class' => 'footer-menu' ) ); 
					}
				?>
			</div>
