	...
	<div class="sub-header">
        ...
        echo '<h1 class="page-title">Events Calendar</h1>';
          ...
          echo '<h1 class="page-title">404</h1>';
        	...
        	if (is_page( 'rider-feedback' ) ) {
        		echo '<h1 class="page-title">We Need Your Feedback!</h1>';
        	}
        	elseif (is_page( array( 'Free Ride', 'Giveaways', 'Survey' ) )) {
        		echo '<a href="https://acta67373.com/rider-feedback/"><h1 class="page-title">< Back to Feedback Home</h1></a>';
        	}
        	else {
            	echo the_title( '<h1 class="page-title">', '</h1>' );
        	}
